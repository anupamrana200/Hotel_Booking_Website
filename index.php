...
<head>
    ...
    <!-- link bootstrap link, google font,bootstrap icons, common.css -->
...
<body class="bg-light">
    ...
    <!-- check avialability form -->
    <div class="container avialability-form">
        <div class="row">
            <div class="col-lg-12 bg-white shadow p-4 rounded">
                <h5 class="mb-4">Check Booking Avialability</h5>
                <form action="rooms.php">
                    <div class="row align-items-end">
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weidth: 500">check-in</label>
                            <input type="date" class="form-control shadow-none" name="checkin" required>
                        </div>
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weidth: 500">check-out</label>
                            <input type="date" class="form-control shadow-none" name="checkout" required>
                        </div>
                        <div class="col-lg-3 mb-3">
                            <label class="form-label" style="font-weidth: 500">Adult</label>
                        ...
                        <div class="col-lg-2 mb-3">
                            <label class="form-label" style="font-weidth: 500">children</label>
                        ...
                        <div class="col-lg-4 col-md-6 my-3">
                            <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="feratures mb-4">
                                        <h6 class="mb-1">Features</h6>
                                        $features_data
                                    </div>
                                    <div class="faciliteies mb-4">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    <a href="tel: + <?php echo $contact_r['pn1'] ?>" class="d-inline-block mb-2 text-decoration-none
                     text-dark"><i class="bi bi-telephone-fill"></i> +
                    ...
                    if ($contact_r['pn2'] != '') {
                        echo <<<data
                            <a href="tel: + $contact_r[pn2]" class="d-inline-block text-decoration-none
                            text-dark"><i class="bi bi-telephone-fill"></i> + $contact_r[pn2]
                           </a>
                        data;
                    }
                    ?>
                ...
                <form id="recovery-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-shield-lock fs-3 me-2"></i> setup a new password
                        </h5>
                    </div>
    ...
    <?php require('inc/footer.php'); ?> <!-- link footer -->
