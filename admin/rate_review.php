                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-4">
                            <a href="?seen=all" class="btn btn-dark rounded-pill shadow-none btn-sm">Mark all read
                                <i class="bi bi-check-all"></i>
                            </a>
                            <a href="?del=all" class="btn btn-danger rounded-pill shadow-none btn-sm">Delete all
