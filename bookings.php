            ...
            while ($data = mysqli_fetch_assoc($result)) {
                ...
                if ($data['booking_status'] == 'booked') {
                    ...
                    if ($data['arrival'] == 1) {
                        ...
                        $btn = "<button onclick='cancel_booking($data[booking_id])' type='button' class='btn btn-outline-danger btn-sm shadow-none'> Cancel Booking </button> ";
                    }
                ...
                echo <<<bookings
                    <div class='col-md-6 col-lg-6 px-4 mb-4'>
