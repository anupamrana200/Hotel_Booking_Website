...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        <div class="h-line bg-dark" style="width: 150px; margin: 0 auto; height: 1.7px">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <input type="number" min="1" value="<?php echo $adult_default ?>" id="adults" oninput="guests_filter()"
                                            class="form-control shadow-none">
                                    </div>
                                    <div>
                                        <label class="form-label">Children</label>
                                        <input type="number" min="0" value="<?php echo $children_default ?>" id="children" oninput="guests_filter()"
                                            class="form-control shadow-none">
                                    </div>
                                </div>
                            </div>
